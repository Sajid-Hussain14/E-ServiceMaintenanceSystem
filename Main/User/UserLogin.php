...
if(!isset($_SESSION['is_login'])){
  if(isset($_REQUEST['rEmail'])){
    ...
    $sql = "SELECT u_email, u_password FROM userlogin_tb WHERE u_email='".$rEmail."' AND u_password='".$rPassword."' limit 1";
...
<body>
  <div class="mb-3 text-center mt-5" style="font-size: 30px;">
    ...
    <span>E-Service Maintenance Portal</span>
  </div>
  <p class="text-center text-primary font-weight-bold" style="font-size: 20px;"> <i class="fas fa-user-secret text-danger"></i> <span >User
      Area</span>
  </p>
  <div class="container-fluid mb-5 ">
    <div class="row justify-content-center custom-margin ">
      <div class="col-sm-6 col-md-4">
        <form action="" class="shadow-lg p-4 bg-info" method="POST">
