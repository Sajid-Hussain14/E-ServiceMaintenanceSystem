...
session_start();
 ...
 if(isset($_REQUEST['empupdate'])){
  ...
  if(($_REQUEST['empName'] == "") || ($_REQUEST['empAdd'] == "") || ($_REQUEST['empMobile'] == "") || ($_REQUEST['empEmail'] == "")){
   ...
   $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill All Fileds </div>';
    ...
    $eAdd = $_REQUEST['empAdd'];
    $eMobile = $_REQUEST['empMobile'];
    $eEmail = $_REQUEST['empEmail'];
  $sql = "UPDATE technician_tb SET empName = '$eName', empAdd = '$eAdd', empMobile = '$eMobile', empEmail = '$eEmail' WHERE empid = '$eId'";
 ...
 ?>
  <form action="" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="empAdd" name="empAdd" value="<?php if(isset($row['empAdd'])) {echo $row['empAdd']; }?>">
    </div>
    <div class="form-group">
