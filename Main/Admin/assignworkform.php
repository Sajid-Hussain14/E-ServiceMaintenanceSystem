...
} else
{
  echo "<script> location.href='login.php'; </script>";
     ...
     if(isset($_REQUEST['assign']))
             {
                ...
                ($_REQUEST['requestername'] == "") ||
             	...
             	($_REQUEST['inputDate'] == ""))
             	{
             		$msg = '<div class="alert alert-warning col-md-6 ml-5 mt-2">All fields are required</div>';
             	} else {
    ...
    $rdate = $_REQUEST['inputDate'];
        ...
        if($conn->query($sql) == TRUE)
   {
  $msg = "<div class='alert alert-success col-sm-5 ml-5 mt-2'>Work Assigned Sucessfully</div>";     
} else{
  $msg = "<div class='alert alert-danger col-sm-5 ml-5 mt-2'>Unable to Assign Work</div>";
}
             	}
             }
 ...
 ?>
     <div class="col-sm-5 mt-5 jumbotron bg-secondary"><!--Start Assigned Work 3rd Column-->
               <?php
            if(isset($msg))
                {echo $msg;}
         ?>
     		...
     		<div class="form-group col-md-4">
     	     ...
     	     <div class="form-row">
     	     	   <div class="form-group col-md-8">
     		         ...
     		         <input type="text" class="form-control" id="requesteremail" name="requesteremail" value="<?php if(isset($row['requester_email'])) 
     	     ...
     	     <div >
     	     	<button type="submit" class="btn btn-success mt-4 btn-block shadow-sm font-weight-bold" name="assign">Assign</button>
