...
if(!isset($_SESSION['is_adminlogin'])){
  if(isset($_REQUEST['aEmail'])){
    ...
    $sql = "SELECT a_email, a_pass FROM adminlogin_tb WHERE a_email='".$aEmail."' AND a_pass='".$aPassword."' limit 1";
...
<body style="background-color: skyblue;">
  ...
  <p class="text-center" style="font-size: 20px;"> <i class="fas fa-user-secret text-success"></i> <span>Admin
      Area</span>
  </p>
      ...
      <div class="col-sm-6 col-md-4">
        <form action="" class="shadow-lg p-4" method="POST">
          <div class="form-group">
            ...
            <small class="form-text">In case if u forgot your email contact our IT cell.</small>
          </div>
          <div class="form-group">
